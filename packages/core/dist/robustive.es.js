...
const SwiftEnum = class SwiftEnum2 {
  constructor(f) {
    ...
    return new Proxy(this, {
      get(target, prop, receiver) {
        return typeof prop === "string" && !(prop in target) ? (associatedValues) => {
          const swiftEnumCase = Object.assign(associatedValues != null ? associatedValues : {}, { case: prop });
          return f !== void 0 ? Object.freeze(Object.assign(f(swiftEnumCase), swiftEnumCase)) : Object.freeze(swiftEnumCase);
        } : Reflect.get(target, prop, receiver);
      }
    });
  }
